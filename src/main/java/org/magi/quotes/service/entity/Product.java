...
public enum Product implements Serializable {
    ...
    CAT1_Q1_1("Matiere-1", BigDecimal.ONE, PriceType.M2),
    CAT1_Q1_2("Matiere-2", BigDecimal.TEN, PriceType.M2),
    CAT1_Q1_3("Matiere-3", BigDecimal.ONE, PriceType.M2),

    CAT1_Q1("Nom de la matière", null, null, new Product[]{CAT1_Q1_1, CAT1_Q1_2, CAT1_Q1_3}),
    CAT1_Q2("Nombre de plaques à produire", BigDecimal.TEN, PriceType.PC),
    CAT1_Q3("Surface en m2", null, PriceType.M2),
